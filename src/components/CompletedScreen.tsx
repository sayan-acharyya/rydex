            ...
            <div className='flex-1 flex flex-col items-center justify-center px-6 py-12'>
                ...
                >
                    ...
                    <p className='text-zinc-500 text-sm text-center mb-8'>
                        {role === "driver"
                            ? "You have successfully dropped off the customer."
                            : "You have been successfully dropped off by the driver."}
                    </p>
                    <div className='bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mb-3'>
                        ...
                        >
                            ...
                            <span
                                ...
                                ${PAYMENT_BADGE[booking.paymentStatus]?.cls ?? "bg-zinc-700 text-zinc-300"}`}
                            >
                    ...
                    <button
                        onClick={() => router.push("/")}
                        className='w-full border border-zinc-700 text-zinc-400 py-3
                        rounded-2xl text-sm font-semibold hover:bg-zinc-900 transition-colors'
                    >
                        Back to Home
                    </button>
